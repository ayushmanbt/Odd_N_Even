(function () {
  ...
  const pauser = document.querySelectorAll(".pauser");
  const volume_changer = document.querySelector("#volume_chnager");
  ...
  volume_changer.addEventListener("click", changeAudioStatus);
  ...
  pauser.forEach((e) => {
    e.addEventListener("click", pauseGame);
  });
  ...
  document.getElementById("arrow_left").addEventListener("click", () => {
    console.log(0);
    answerHandle(ANSWER_OPTIONS.left);
  });
  document.getElementById("arrow_right").addEventListener("click", () => {
    console.log(1);
    answerHandle(ANSWER_OPTIONS.right);
  });
  ...
  document
    .getElementById("highscore_clearer")
    .addEventListener("click", clearHighScore);
